<template>
  <div class="app-container">
    ...
    <div class="title-container">
      ...
      <el-col :span="12" style="text-align: right;">
        <el-tooltip content="Create Pemasok" placement="top">
          <el-button type="success" round icon="el-icon-plus" @click="$router.push('/purchase/bills/create')">Tagihan Baru</el-button>
        </el-tooltip>
      </el-col>
    </div>
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="dataList" fit @sort-change="sortChange">
      <el-table-column label="Tanggal Jatuh Tempo | Tanggal Tagihan" prop="efc_nrp">
